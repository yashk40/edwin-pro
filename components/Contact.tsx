...
interface ContactProps {
   onNavigate?: (view: 'home' | 'store' | 'contact') => void;
}
   ...
   return (
      <div className="min-h-screen pt-20 md:pt-32 pb-20 bg-slate-50">
         <div className="container mx-auto px-6">
            ...
            <div className="flex items-center gap-2 mb-6 text-sm max-w-6xl mx-auto">
               <button
            ...
            <div className="text-center max-w-3xl mx-auto mb-16">
               ...
               <BlurText
                  text="Start Your Dream Project"
                  className="text-3xl md:text-5xl font-bold tracking-tight text-slate-900 font-display mb-6 justify-center"
                  animateBy="words"
                  direction="top"
               />
