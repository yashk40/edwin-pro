          ...
          <div className="relative h-64 md:h-96">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex items-end">
              <div className="p-8 text-white w-full">
                ...
                <BlurText
                  text={project.title}
                  className="text-3xl md:text-5xl font-display font-bold drop-shadow-md text-white"
                  animateBy="words"
                  direction="top"
                />
              </div>
          ...
          <FadeIn>
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <BlurText
                ...
                className="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 mb-3 font-display justify-center"
                animateBy="words"
                direction="top"
              />
            ...
            {projects.map((project) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col grow">
                  ...
                  <BlurText
                    text={project.title}
                    className="text-2xl font-display font-bold text-slate-900 mb-3 group-hover:text-primary-700 transition-colors leading-tight"
                    animateBy="words"
                    direction="top"
                  />
        ...
        <div className="container mx-auto px-6">
          <FadeIn>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <BlurText
                text="On-Site Gallery"
                className="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 mb-6 font-display justify-center"
                animateBy="words"
                direction="top"
              />
          ...
          <FadeIn>
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <BlurText
                ...
                className="text-3xl md:text-5xl font-bold tracking-tight text-slate-900 font-display justify-center"
                animateBy="words"
                direction="top"
              />
            </div>
